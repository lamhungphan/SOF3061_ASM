...
VALUES ('director', '123', 'admin@samsung.com', 'Admin Samsung', '0123456789', 'Hà Nội, Việt Nam', 'DIRECTOR'),
...
VALUES ('Điện thoại Samsung'),
       ('Máy tính bảng Samsung'),
       ('Đồng hồ Samsung'),
       ('Phụ kiện Samsung');

INSERT INTO products (name, quantity, size, description, image, price, publish_date, last_update_time, category_id)
VALUES ('Samsung Galaxy S24 Ultra', 50, NULL, 'Flagship Samsung 2024', 's24_ultra.jpg', 29990000, NOW(), NOW(), 1),
       ('Samsung Galaxy S23', 100, NULL, 'Điện thoại Samsung cao cấp', 's23.jpg', 19990000, NOW(), NOW(), 1),
       ('Samsung Galaxy Tab S9', 30, '12.4 inch', 'Máy tính bảng flagship Samsung', 'tab_s9.jpg', 24990000, NOW(),
        NOW(), 2),
...
VALUES (2, 1, 1), -- user1 mua Galaxy S24 Ultra
...
VALUES (2, 38970000, NOW(), 'PENDING'), -- user1 đặt hàng
       (3, 26990000, NOW(), 'SHIPPED'); -- user2 đặt hàng

INSERT INTO order_details (order_id, product_id, quantity, price)
VALUES (1, 19, 1, 29990000),
       (1, 21, 2, 8990000),
       (2, 23, 1, 24990000),
       (2, 26, 3, 500000);
